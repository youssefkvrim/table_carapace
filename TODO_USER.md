...
```
/home/pi/Desktop/table_carapace/
├── app.py
├── table_carapace/          # Application package
│   ├── __main__.py
│   ├── application.py
│   ├── config.py
│   ├── ...
...
```bash
cd /home/pi/Desktop/table_carapace
...
if [ "$(tty)" = "/dev/tty1" ]; then
    /home/pi/Desktop/table_carapace/autostart.sh
fi
```
...
1. Check if autostart.sh is executable:
   ...
   ```bash
   ls -la /home/pi/Desktop/table_carapace/autostart.sh
   ```

   Should show `-rwxr-xr-x`. If not:

   ```bash
   chmod +x /home/pi/Desktop/table_carapace/autostart.sh
   ```
